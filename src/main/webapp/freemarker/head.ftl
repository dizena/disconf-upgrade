        ...
        <link rel="stylesheet" href="/html/dep/bootstrap/css/bootstrap.css" />
        <!--[if lte IE 6]>
        <link rel="stylesheet" href="/html/dep/bootstrap/css/bootstrap-ie6.css" />
        <![endif]-->
        <!--[if lte IE 7]>
        <link rel="stylesheet" href="/html/dep/bootstrap/css/ie.css" />
        <![endif]-->
        <![if !IE]>
        <link rel="stylesheet" href="/html/dep/bootstrap/css/noie.css" />
        <![endif]>
        <link rel="stylesheet" href="/html/dep/jquery-ui-1.10.4.custom/css/ui-lightness/jquery-ui-1.10.4.custom.css" />
        <link rel="stylesheet" type="text/css" href="/html/assets/css/project.css" />
    </head>
            ...
            <div class="navbar-inner zu-top">
                <div class="container">
                    ...
                    <div class="nav-collapse collapse">
                        ...
                        <a id="brand_url" href="/main" class="brand" style="margin-left:0px;padding:8px;"> <span class="zu-top-nav-link">Disconf</span> </a>
