...
public class DisconfRemoteBizItemApi extends DisconfRemoteBaseApi {
	...
	public boolean updateFile(ConfNewForm confNewForm, MultipartFile file) {
		try {
			...
			HttpEntity httpEntity = MultipartEntityBuilder.create().addBinaryBody("myfilerar", file.getInputStream())
					.addTextBody("appId", confNewForm.getAppId() + "").addTextBody("version", confNewForm.getVersion())
					.addTextBody("envId", confNewForm.getEnvId() + "").build();
	...
	public boolean updateItem(long configId, String value) {
		try {
			...
			HttpEntity httpEntity = EntityBuilder.create().setText(value).build();
	...
	public boolean updateFile(long configId, MultipartFile file) {
		try {
			...
			HttpEntity httpEntity = MultipartEntityBuilder.create()
					.addBinaryBody("myfilerar", file.getInputStream())
					.build();
	...
	public boolean updateFileWithText(long configId, String fileContent) {
		try {
			...
			HttpEntity httpEntity = EntityBuilder.create().setText(fileContent).build();
